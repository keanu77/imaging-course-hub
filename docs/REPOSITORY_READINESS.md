...
- GitHub：`keanu77/imaging-course-hub`；可見性維持 `PRIVATE`。系列只有肩部、膝部公開，其他五部位與主頁 repo 私有。
- 整備前版本：`9d6a9b80bbc8efc13411490b123d149f315dfc95`。
...
- 主頁建置、test_build.py、兩組 Playwright 互動測試通過；測試支援 PLAYWRIGHT_MODULE 與 BASE_URL。

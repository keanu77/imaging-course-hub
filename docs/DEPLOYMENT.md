...
| 設定 | 現況 |
| --- | --- |
| GitHub | keanu77/imaging-course-hub（PRIVATE） |
| 正式分支 | main |
| Cloudflare Pages 專案 | imaging-course-hub |
| 建置根目錄 | repo 根目錄 |
| 建置指令 | `python3 build.py && python3 test_build.py` |
| 輸出目錄 | dist |
| 正式網址 | https://imaging-course-hub.sportsmedicine.tw/ |
